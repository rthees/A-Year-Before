                      ...
                      function ayb_posts($ayb_para)
                        {
                          ...
                          /*
                           ...
                           'name' => 'Sidebar 1',
                           'id' => 'sidebar-1',
                           'before_widget' => '<li id="ayb_posts-10" class="widget ayb_posts"> ',
                           'after_widget' => '</li>',
                           'before_title' => '<h2 class="widgettitle">',
                           'after_title' => '</h2>',
                           'widget_id' => 'ayb_posts-10',
                           'widget_name' => 'A Year Before'
                           );
                           */
                          //print_r($b);
...
>>>>>>> ef427321353a51d7f410f9f5f3f7364de829add2:ayb_posts.php
?>