...
if (!class_exists('ayb_posts_class')) {
	class ayb_posts_class extends WP_Widget {
		...
		function form($instance) {
			...
			$defaults = array('title' => __("A year before", 'ayb_posts'), 'day' => '0', 'month' => '0', 'year' => '1', 'range' => '0', 'dateformat' => __('Y-m-d', 'ayb_posts'), 'anniversary' => '0', 'showdate' => '1', 'private' => '0', 'showpages' => '0', 'posts_max' => '0', 'notfound' => __('No articles on this date.', 'ayb_posts'), 'pattern' => __($this -> pattern_dafault, 'ayb_posts'));
